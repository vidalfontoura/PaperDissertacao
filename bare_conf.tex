...
A specific terminal set for the acceptance criterion were also defined.
 ...
 Using these statistic data and a function set of contained the following operations: addition, subtraction, multiplication and division, a grammar was designed to support the generation of the high level heuristics. The designed grammar to generate the selection mechanism and acceptance criterion is presented in the Grammar \ref{grammar:proposedGrammar}.
