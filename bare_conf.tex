...
This paper proposes the automated generation of high level heuristics to a hyper-heuristic framework to the protein structure problem. In order to generate the high level heuristics: evolution grammatical (EG) will be used, which is a type of genetic programming (PG). The EG will generate selection mechanisms and acceptance criteria to hyper-heuristics framework.
